...
namespace Snollygosters
{
    ...
    /// </summary>
    public class Snollygosters : Microsoft.Xna.Framework.Game
    {
        ...
        public Snollygosters()
        {
            //TESTING
            //cashList.Add(new Cash(50, 50));
            //cashList.Add(new Cash(400, 20));
            //taxList.Add(new Tax(300, 30, taxAmount));
            //TESTING
